...
AdaptAble is built to keep your browsing private. The claims below are the ones the app actually implements — the same list appears in the extension's in-app privacy panel.
...
## Your controls
- **Undo** reverts the last change; **Reset** removes every AdaptAble change and clears injected state.
